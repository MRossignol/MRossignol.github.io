(function() {
  ...
  let buildPage = (root) => {
    ...
    content.tracks.forEach((t,i) => {
      ...
      let playImg = makeImg('img/icons/play.svg', 'trackStatus', 'pause');
      track.appendChild(playImg);
      let pauseImg = makeImg('img/icons/pause.svg', 'trackStatus', 'playing');
      track.appendChild(pauseImg);
      let transImg = makeImg('img/icons/transition_anim.svg', 'trackStatus', 'transition');
